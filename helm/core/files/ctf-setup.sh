...
while true; do
    ...
    function accept_eula() {
        ...
        curl -k -s -H "Content-Type: application/json" -H "X-Auth-Token: ${TOKEN}" \
    ...
    function finish_config() {
        timeout=$(curl -s -k -X GET -H "Content-Type: application/json" -H "X-Auth-Token: ${TOKEN}" \
    ...
    if curl -k -s -H "Content-Type: application/json" \
        ...
        if curl -k -s -X GET -H "Content-Type: application/json" -H "X-Auth-Token: ${TOKEN}" \
